...
class RecipeViewModel: ObservableObject {
    // @Published + ObservableObject create observable properties in order to  reactive programming and automatic UI updates.
    // By using @Published, whenever the recipeModels array is modified or updated, a notification will be sent to any subscribers.
    // Subscribers that have accessed the property using the @ObservedObject or @StateObject attributes, allowing them to be automatically updated with the latest data.
