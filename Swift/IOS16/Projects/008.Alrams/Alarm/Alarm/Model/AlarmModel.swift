...
struct AlarmModel: Identifiable {
    ...
    static func DefaultAlaram() -> AlarmModel {
        return AlarmModel(title: "Activity Completed",
    ...
    /// Info: This return an array of Dummy Data of Alarm Model
    static func DummyAlarmData() -> [AlarmModel] {
        [
            ...
            .sorted(by: {
                // $0 represents the first element being compared.
                // $1 represents the second element being compared.
                $0.endTime < $1.endTime
            })
    }
}
