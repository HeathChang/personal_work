...
// const solution = (surveys, choices) => {
// 	let result = '';
...
// 		let param = ''
// 		if ( scoreArr[choice] > 0 ) {
// 			 param =  surveys[i].split("")[0]
// 		} else if(scoreArr[choice] < 0 ){
// 				param = surveys[i].split("")[1]
// 		}
//
// 		for ( let item of resultArr ) {
// 			if(Object.keys(item)[0]=== param) {
// 				item[`${param}`] = Math.abs(scoreArr[choice])
// 			} else if(Object.keys(item)[1]=== param) {
// 				item[`${param}`] = Math.abs(scoreArr[choice])
// 			}
// 		}
// 	}
// 	for ( let i = 0 ; i < resultArr.length ; i++ ) {
// 		result += Object.values(resultArr[i])[0] < Object.values(resultArr[i]) [1] ? Object.keys(resultArr[i])[1] : Object.keys(resultArr[i])[0]
// 	}
// 	return result;
// }
//
