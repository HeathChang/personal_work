...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 18, 4, 328);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 15, 2, 268);
    			add_location(h2, file$2, 16, 2, 287);
    			add_location(button0, file$2, 20, 2, 358);
    			add_location(button1, file$2, 21, 2, 410);
    			add_location(article, file$2, 14, 0, 256);
    		},
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 75, 6, 1507);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 61, 0, 1113);
    			attr_dev(header, "class", "svelte-1bqcya2");
    			add_location(header, file$1, 63, 2, 1196);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 66, 2, 1246);
    			add_location(p, file$1, 70, 4, 1321);
    			add_location(button, file$1, 71, 4, 1382);
    			attr_dev(div2, "class", "disclaimer");
    			add_location(div2, file$1, 69, 2, 1292);
    			add_location(footer, file$1, 73, 2, 1449);
    			attr_dev(div3, "class", "modal svelte-1bqcya2");
    			add_location(div3, file$1, 62, 0, 1174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:0) {#each products as product}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, closeable, showModal*/ 4114) {
    ...
    // (54:2) <Modal     on:cancel={() => (showModal = !showModal)}     on:close={() => (showModal = !showModal)}     let:didAgree={closeable}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(54:2) <Modal     on:cancel={() => (showModal = !showModal)}     on:close={() => (showModal = !showModal)}     let:didAgree={closeable}>",
    		ctx
    	});
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 57, 4, 1311);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 59, 4, 1368);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 50, 0, 1088);
    			attr_dev(textarea, "rows", "5");
    			textarea.value = /*text*/ ctx[0];
    			add_location(textarea, file, 68, 0, 1519);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(1, showModal = !showModal);
    	const click_handler_1 = () => $$invalidate(1, showModal = !showModal);
    	const cancel_handler = () => $$invalidate(1, showModal = !showModal);
    	const close_handler = () => $$invalidate(1, showModal = !showModal);
