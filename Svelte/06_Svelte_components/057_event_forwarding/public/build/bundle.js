...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 1, 4, 14);
    			add_location(button0, file, 2, 4, 42);
    			add_location(button1, file, 3, 4, 100);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*addToCart*/ ctx[2], false, false, false),
    ...
    class Product extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*productTitle*/ ctx[0] === undefined && !('productTitle' in props)) {
    ...
    function create_fragment(ctx) {
    	...
    	product.$on("add-to-cart", /*add_to_cart_handler*/ ctx[0]);
    	product.$on("delete", /*delete_handler*/ ctx[1]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [add_to_cart_handler, delete_handler];
    }
