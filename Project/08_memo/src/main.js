...
import BaseCard from '@/components/common/layouts/BaseCard'
import BaseButton from '@/components/common/layouts/BaseButton'
import BaseBadge from '@/components/common/layouts/BaseBadge'
...
app.config.globalProperties.$MemoSvc = MemoSvc
